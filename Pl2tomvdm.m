function [fname,pl2,n,freqs,j,lfpchan,ad,adfreq,fn,i,LFPTs,temp,TimeSampEr,ts,WBchan,eventTs] = Pl2tomvdm(x)
%%
% load file and create pl2 struct
cd('C:\Users\Lucas\Desktop\data');
fname = x;
pl2 = PL2GetFileIndex(x);
